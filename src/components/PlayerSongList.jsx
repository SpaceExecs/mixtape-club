...
const PlayerSongList = (props) => {
  const {
    aSideTitles, bSideTitles, currentSong, aSideLinks, bSideLinks, onFlip, currentPlaylistId, toggleLink, onToggleLink,
  } = props;
          ...
          <div className="tab-content" id="v-pills-tabContent">
            <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
              <ul className="list-group list-group-flush builder-tracks">
                <li className="list-group-item track-li" style={(currentSong === aSideLinks[0]) ? { backgroundColor: '#a7dae7' } : { backgroundColor: '#fff' }}>
                  {aSideTitles[0]}
                  {' '}
                </li>
                <li className="list-group-item track-li" style={(currentSong === aSideLinks[1]) ? { backgroundColor: '#a7dae7' } : { backgroundColor: '#fff' }}>
                  {aSideTitles[1]}
                  {' '}
                </li>
                <li className="list-group-item track-li" style={(currentSong === aSideLinks[2]) ? { backgroundColor: '#a7dae7' } : { backgroundColor: '#fff' }}>
                  {aSideTitles[2]}
                  {' '}
                </li>
                <li className="list-group-item track-li" style={(currentSong === aSideLinks[3]) ? { backgroundColor: '#a7dae7' } : { backgroundColor: '#fff' }}>
                  {aSideTitles[3]}
                  {' '}
                </li>
                <li className="list-group-item track-li" style={(currentSong === aSideLinks[4]) ? { backgroundColor: '#a7dae7' } : { backgroundColor: '#fff' }}>
                  {aSideTitles[4]}
                  {' '}
                </li>
              </ul>
